...
func (ps *ProfileService) Save(name, authToken, baseURL, description string) ConfigResponse {
	// Validate inputs
...
func (ps *ProfileService) LoadAll() ConfigResponse {
	profilesDir := ps.GetProfilesDir()
...
func (ps *ProfileService) Apply(profileName string) ConfigResponse {
	profilesDir := ps.GetProfilesDir()
...
func (ps *ProfileService) Delete(profileName string) ConfigResponse {
	profilesDir := ps.GetProfilesDir()
	profilePath := filepath.Join(profilesDir, profileName+".json")
...
func (ps *ProfileService) loadFromFile(filePath string) (ConfigProfile, error) {
